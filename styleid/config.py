...
def get_args():
    ...
    parse.add_argument('--cnt_fn', type=str, required=True, default='data/cnt/00.png')
    parse.add_argument('--sty_fn', type=str, required=True, default='data/sty/01.png')
    parse.add_argument('--save_dir', type=str, required=True, default='output')
