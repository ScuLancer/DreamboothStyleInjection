...
if __name__ == "__main__":
    ...
    # create save_dir and save_dir/intermediate
    ...
    for layer_name in style_features.keys():
        # print(content_features[layer_name])
    ...
    denoise_kwargs = unet_wrapper.get_text_condition(content_text)
    print("style latent shape:",style_latent.shape)
    ...
    # change this!
    save_image(image_last, os.path.join(save_dir))
